...
function LoadLoginBox()
{
  if(loginStatus == "false") {
    ...
    document.getElementById('ButtonText').value = "Login";
    ...
    document.getElementById('ButtonText').value = "My Account";
...
{
  if(loginStatus == "false") {
    window.location = LINK_ACCOUNT + "account/accountmanagement";
  } else {
    window.location = LINK_ACCOUNT + "account/accountmanagement";
  }
}
function LoginstatusTextAction(source) {
  if(loginStatus == "false") {
    window.location = LINK_ACCOUNT + "account/createaccount";
  } else {
    window.location = LINK_ACCOUNT + "account/accountmanagement/logout";
  }
}
