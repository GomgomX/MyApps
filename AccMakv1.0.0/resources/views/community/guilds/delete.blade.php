<x-layout :$pageTitle :$subtopic>
    ...
    @if(!isset($action))
        ...
        If your guild owns a guild hall, all items inside will be destroyed.<br>Please make sure your guild hall has been cleared before disbanding your guild.<br>
        <form style="display:inline-block; margin:0; padding:0;" action="/community/guilds/deleteguild" METHOD=post>
        @csrf
        @method('delete')
